...
package mycom.android.prefs;

import java.io.File;

import util.SdcardManager;
...
public final class AndroidLocation {
    ...
    public final static String getFolder() throws AndroidLocationException {
        if (sPrefsLocation == null) {
            String home = SdcardManager.ROOT_PATH+"/android-sdk-linux"; 
            		//findValidPath("ANDROID_SDK_HOME", "user.home", "HOME");
