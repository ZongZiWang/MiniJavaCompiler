...
package mycom.android.sdklib.build;

import mycom.android.sdklib.SdkConstants;
import mycom.android.sdklib.internal.build.DebugKeyProvider;
import mycom.android.sdklib.internal.build.SignedJarBuilder;
import mycom.android.sdklib.internal.build.DebugKeyProvider.IKeyGenOutput;
import mycom.android.sdklib.internal.build.DebugKeyProvider.KeytoolException;
import mycom.android.sdklib.internal.build.SignedJarBuilder.IZipEntryFilter;
...
public final class ApkBuilder {
    ...
    public ApkBuilder(String apkOsPath, String resOsPath, String dexOsPath, String storeOsPath,
        ...
        this(new SdcardFile(apkOsPath),
             new SdcardFile(resOsPath),
             dexOsPath != null ? new SdcardFile(dexOsPath) : null,
             storeOsPath,
             verboseStream);
    }
    ...
    public ApkBuilder(File apkFile, File resFile, File dexFile, String storeOsPath,
        ...
        try {
            File storeFile = null;
            if (storeOsPath != null) {
                storeFile = new SdcardFile(storeOsPath);
    ...
    public static boolean checkFileForPackaging(String fileName, String extension) {
        // Note: this method is used by mycom.android.ide.eclipse.adt.internal.build.ApkBuilder
